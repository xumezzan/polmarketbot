...
from app.models.enums import MarketSide, PositionStatus
...
class Position(TimestampMixin, Base):
    """Current or historical paper position opened from a signal."""
    ...
    status: Mapped[PositionStatus] = mapped_column(
        sa.Enum(PositionStatus, name="position_status_enum"),
        nullable=False,
        index=True,
    )
    ...
    paper_trades: Mapped[list["PaperTrade"]] = relationship(back_populates="position")
