...
class OpenAILLMClient:
                ...
                messages=[
                    {
                        ...
                        "content": (
                            ...
                            "Use a strict resolvable-event catalyst style and do not invent facts. "
    ...
    def _build_user_prompt(self, news_item: NewsItem) -> str:
        ...
        return (
            ...
            "Current strategy: trade only resolvable event catalysts, not general sentiment. "
            "Only return YES or NO when the item is breaking news or a confirmed, direct "
            "catalyst for a specific binary market whose resolution criteria are about the "
            "same event. The market must be specifically about the event in the news, not "
            "just the same broad topic or person. Examples: "
            ...
            "news, product thought leadership, vague AI/crypto impact, price prediction, "
            "technical analysis, or price movement without a confirmed market-resolution "
            "catalyst. Do not trade a Bitcoin or crypto price target market from bullish or "
            "bearish commentary alone. If the news does not directly and obviously change "
            "the probability of the chosen market, return NONE. "
