...
class Settings(BaseSettings):
    ...
    llm_min_tradability_score_for_market_pipeline: float = 0.35
    llm_min_market_specificity_score_for_market_pipeline: float = 0.35
    news_api_key: str = ""
    rss_feed_urls: str = ""
    ...
    live_min_paper_win_rate: float = 0.40
    live_require_phase_gate_passed: bool = True
    live_phase_gate_window_days: int = 30
    ...
    gamma_market_cache_enabled: bool = True
    gamma_market_cache_path: str = ".cache/gamma_markets.json"
    gamma_market_cache_max_age_minutes: int = 120
    market_top_n: int = 5
    ...
    signal_actionable_edge_threshold: float = 0.08
    signal_actionable_confidence_threshold: float = 0.70
    signal_actionable_relevance_threshold: float = 0.70
    ...
    risk_min_relevance: float = 0.70
    risk_min_causality_score: float = 0.70
    risk_allowed_event_categories: str = "ELECTION,COURT_DECISION,POLITICIAN_HEALTH,WAR_CONFLICT"
    risk_allowed_news_qualities: str = "CONFIRMED_EVENT,OFFICIAL_STATEMENT"
    risk_require_direct_market_event_match: bool = True
    risk_max_news_age_minutes: int = 180
    risk_enable_extended_news_age_window: bool = False
    risk_extended_max_news_age_minutes: int = 180
    ...
    risk_min_match_score: float = 0.40
    ...
    risk_max_trades_per_day: int = 2
    risk_max_trade_size_usd: float = 50.0
    risk_max_liquidity_share: float = 0.02
    risk_block_on_existing_position: bool = True
    risk_allow_stronger_duplicate_position: bool = False
    risk_duplicate_min_edge_improvement: float = 0.15
    ...
    paper_edge_exit_enabled: bool = True
    paper_min_current_edge: float = 0.00
    paper_max_edge_deterioration: float = 0.12
    paper_edge_exit_grace_minutes: int = 30
    paper_opposite_news_exit_enabled: bool = True
    paper_opposite_news_min_confidence: float = 0.70
    paper_opposite_news_min_relevance: float = 0.60
    paper_opposite_news_min_token_overlap: int = 1
    paper_opposite_news_lookback_minutes: int = 1440
    ...
    scheduler_delete_stale_pending_news: bool = True
    ...
    anomaly_hunter_enabled: bool = True
    anomaly_hunter_analysis_interval_hours: int = 6
    anomaly_hunter_daily_report_hour_utc: int = 1
    anomaly_hunter_min_alert_score: float = 60.0
    adaptive_trading_enabled: bool = True
    adaptive_disable_on_panic: bool = True
    market_regime_adx_trend_threshold: float = 30.0
    market_regime_low_volatility_threshold: float = 0.25
    market_regime_high_volatility_threshold: float = 0.75
    market_regime_panic_threshold: float = 0.85
    market_regime_low_liquidity_threshold: float = 0.30
    market_regime_news_driven_threshold: float = 0.75
    market_regime_breakout_threshold: float = 0.70
    strategy_orchestrator_min_cash_allocation: float = 0.20
    strategy_orchestrator_panic_cash_allocation: float = 1.00
    confidence_min_live_score: float = 0.70
    confidence_min_shadow_score: float = 0.50
    confidence_min_timeframe_alignment: float = 0.55
    confidence_full_position_threshold: float = 0.80
    confidence_reduced_position_threshold: float = 0.60
    confidence_max_uncertainty_for_live: float = 0.35
    meta_learning_enabled: bool = True
    ai_memory_min_observations: int = 20
    ai_memory_min_strategy_confidence: float = 0.45
    ai_memory_similarity_threshold: float = 0.72
    meta_learning_win_rate_drop_threshold: float = 0.15
    meta_learning_sharpe_drop_threshold: float = 0.50
    meta_learning_drawdown_increase_threshold: float = 0.10
    meta_learning_volatility_increase_threshold: float = 0.25
    meta_learning_accuracy_drop_threshold: float = 0.10
    meta_learning_decay_disable_threshold: float = 0.75
    meta_learning_decay_reduce_threshold: float = 0.35
    market_structure_shift_threshold: float = 0.60
    market_structure_liquidity_drop_threshold: float = 0.30
    market_structure_spread_widening_bps: float = 250.0
    market_structure_correlation_shift_threshold: float = 0.65
    market_structure_volatility_shift_threshold: float = 0.70
    shadow_testing_min_observations: int = 30
    self_improvement_min_oos_score: float = 0.65
    self_improvement_min_walk_forward_score: float = 0.65
    self_improvement_min_monte_carlo_score: float = 0.70
    self_improvement_min_shadow_score: float = 0.65
    staged_rollout_initial_capital_fraction: float = 0.01
    staged_rollout_max_initial_capital_fraction: float = 0.05
    risk_regime_normal_size_multiplier: float = 1.00
    risk_regime_range_size_multiplier: float = 0.75
    risk_regime_high_vol_size_multiplier: float = 0.50
    risk_regime_low_liquidity_size_multiplier: float = 0.25
    risk_regime_panic_size_multiplier: float = 0.00
